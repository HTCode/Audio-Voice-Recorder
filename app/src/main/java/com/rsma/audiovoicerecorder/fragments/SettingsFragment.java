package com.rsma.audiovoicerecorder.fragments;
...
import com.rsma.audiovoicerecorder.BuildConfig;
import com.rsma.audiovoicerecorder.MySharedPreferences;
import com.rsma.audiovoicerecorder.R;
import com.rsma.audiovoicerecorder.activities.SettingsActivity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        aboutPref.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                com.rsma.audiovoicerecorder.fragments.LicensesFragment licensesFragment = new com.rsma.audiovoicerecorder.fragments.LicensesFragment();
